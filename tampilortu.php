...
<head>
    ...
    <title>ImunKu - Data Orangtua</title>
...
<body>
    ...
    <div class="content">
        ...
        <a href="tambahortu.php" class="btn btn-custom mb-3"><i class="fa fa-plus"></i> Tambah Data Orangtua</a>
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                ...
                include 'koneksi.php';
                $no = 1;
                $data = mysqli_query($koneksi, "SELECT * FROM orangtua");
                while($d = mysqli_fetch_array($data)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="ubahortu.php?id=<?php echo $d['id_orangtua']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                            <a href="hapusortu.php?id=<?php echo $d['id_orangtua']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                    <?php 
                }
