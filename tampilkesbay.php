...
<head>
    ...
    <title>ImunKu - Data Kesehatan Bayi</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="tampilbayi.php"><i class="fa fa-notes-medical"></i> Data Bayi</a>
    ...
    <div class="content">
        ...
        <a href="tambahkesbay.php" class="btn btn-custom mb-3"><i class="fa fa-plus"></i> Tambah Data Bayi</a>
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                ...
                include 'koneksi.php';
                $no = 1;
                $data = mysqli_query($koneksi, "SELECT * FROM kesehatan_bayi");
                while($d = mysqli_fetch_array($data)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="ubahkesbay.php?id=<?php echo $d['id_kesehatan']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                            <a href="hapuskesbay.php?id=<?php echo $d['id_kesehatan']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                    <?php 
                }
